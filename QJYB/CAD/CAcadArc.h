...
// CAcadArc wrapper class

class CAcadArc : public COleDispatchDriver
{
public:
	CAcadArc(){} // Calls COleDispatchDriver default constructor
	CAcadArc(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadArc(const CAcadArc& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	VARIANT Offset(double Distance)
	{
		VARIANT result;
		static BYTE parms[] = VTS_R8 ;
		InvokeHelper(0xa, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, Distance);
		return result;
	}
	double get_Area()
	{
