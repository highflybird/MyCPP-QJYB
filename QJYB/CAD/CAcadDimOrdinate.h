...
// CAcadDimOrdinate wrapper class

class CAcadDimOrdinate : public COleDispatchDriver
{
public:
	CAcadDimOrdinate(){} // Calls COleDispatchDriver default constructor
	CAcadDimOrdinate(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadDimOrdinate(const CAcadDimOrdinate& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
