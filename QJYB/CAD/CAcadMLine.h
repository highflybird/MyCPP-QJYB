...
// CAcadMLine wrapper class

class CAcadMLine : public COleDispatchDriver
{
public:
	CAcadMLine(){} // Calls COleDispatchDriver default constructor
	CAcadMLine(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadMLine(const CAcadMLine& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
