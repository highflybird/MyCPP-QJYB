...
// CAcadXline wrapper class

class CAcadXline : public COleDispatchDriver
{
public:
	CAcadXline(){} // Calls COleDispatchDriver default constructor
	CAcadXline(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadXline(const CAcadXline& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	VARIANT Offset(double Distance)
	{
		VARIANT result;
		static BYTE parms[] = VTS_R8 ;
		InvokeHelper(0x4, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, Distance);
		return result;
	}
