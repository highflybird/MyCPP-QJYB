...
// CAcadBlocks wrapper class

class CAcadBlocks : public COleDispatchDriver
{
public:
	CAcadBlocks(){} // Calls COleDispatchDriver default constructor
	CAcadBlocks(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadBlocks(const CAcadBlocks& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	LPDISPATCH Add(VARIANT& InsertionPoint, LPCTSTR Name)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_VARIANT VTS_BSTR ;
		InvokeHelper(0x2, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &InsertionPoint, Name);
		return result;
	}
