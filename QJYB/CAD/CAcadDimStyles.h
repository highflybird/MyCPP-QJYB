...
// CAcadDimStyles wrapper class

class CAcadDimStyles : public COleDispatchDriver
{
public:
	CAcadDimStyles(){} // Calls COleDispatchDriver default constructor
	CAcadDimStyles(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadDimStyles(const CAcadDimStyles& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
