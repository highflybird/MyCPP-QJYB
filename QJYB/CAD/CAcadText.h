...
// CAcadText wrapper class

class CAcadText : public COleDispatchDriver
{
public:
	CAcadText(){} // Calls COleDispatchDriver default constructor
	CAcadText(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadText(const CAcadText& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
