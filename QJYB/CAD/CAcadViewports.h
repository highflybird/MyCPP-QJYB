...
// CAcadViewports wrapper class

class CAcadViewports : public COleDispatchDriver
{
public:
	CAcadViewports(){} // Calls COleDispatchDriver default constructor
	CAcadViewports(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadViewports(const CAcadViewports& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x3, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Name);
	}
