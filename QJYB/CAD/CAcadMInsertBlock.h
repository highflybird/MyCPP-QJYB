...
// CAcadMInsertBlock wrapper class

class CAcadMInsertBlock : public COleDispatchDriver
{
public:
	CAcadMInsertBlock(){} // Calls COleDispatchDriver default constructor
	CAcadMInsertBlock(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadMInsertBlock(const CAcadMInsertBlock& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void put_Columns(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
