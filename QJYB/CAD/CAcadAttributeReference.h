...
// CAcadAttributeReference wrapper class

class CAcadAttributeReference : public COleDispatchDriver
{
public:
	CAcadAttributeReference(){} // Calls COleDispatchDriver default constructor
	CAcadAttributeReference(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadAttributeReference(const CAcadAttributeReference& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	// IAcadAttributeReference methods
public:
	CString get_Handle()
	{
		CString result;
