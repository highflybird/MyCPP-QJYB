...
// CAcadRasterImage wrapper class

class CAcadRasterImage : public COleDispatchDriver
{
public:
	CAcadRasterImage(){} // Calls COleDispatchDriver default constructor
	CAcadRasterImage(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadRasterImage(const CAcadRasterImage& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void put_ImageWidth(double newValue)
	{
		static BYTE parms[] = VTS_R8 ;
	...
	void put_ImageHeight(double newValue)
	{
		static BYTE parms[] = VTS_R8 ;
	...
	void put_ImageFile(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x9, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	CString get_ImageFile()
	{
		CString result;
		InvokeHelper(0x9, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
		return result;
	}
	BOOL get_ImageVisibility()
	{
		BOOL result;
		InvokeHelper(0xa, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_ImageVisibility(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0xa, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	BOOL get_ClippingEnabled()
	{
		BOOL result;
		InvokeHelper(0xb, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_ClippingEnabled(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
	...
	void ClipBoundary(VARIANT& boundry)
	{
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0xd, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &boundry);
	}
	double get_Height()
	{
		double result;
	...
	BOOL get_ShowRotation()
	{
		BOOL result;
		InvokeHelper(0x10, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_ShowRotation(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
