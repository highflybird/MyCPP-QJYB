...
// CAcadPolyfaceMesh wrapper class

class CAcadPolyfaceMesh : public COleDispatchDriver
{
public:
	CAcadPolyfaceMesh(){} // Calls COleDispatchDriver default constructor
	CAcadPolyfaceMesh(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadPolyfaceMesh(const CAcadPolyfaceMesh& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	long get_NumberOfVertices()
	{
		long result;
		InvokeHelper(0x3, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	long get_NumberOfFaces()
	{
		long result;
		InvokeHelper(0x4, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_Faces(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT ;
