...
// CAcadObject wrapper class

class CAcadObject : public COleDispatchDriver
{
public:
	CAcadObject(){} // Calls COleDispatchDriver default constructor
	CAcadObject(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadObject(const CAcadObject& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
