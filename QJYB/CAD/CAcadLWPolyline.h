...
// CAcadLWPolyline wrapper class

class CAcadLWPolyline : public COleDispatchDriver
{
public:
	CAcadLWPolyline(){} // Calls COleDispatchDriver default constructor
	CAcadLWPolyline(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadLWPolyline(const CAcadLWPolyline& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void AddVertex(long Index, VARIANT& vertex)
	{
		static BYTE parms[] = VTS_I4 VTS_VARIANT ;
		InvokeHelper(0x4, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Index, &vertex);
	}
	VARIANT Explode()
	{
		VARIANT result;
	...
	void SetBulge(long Index, double bulge)
	{
		...
		InvokeHelper(0x7, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Index, bulge);
	}
	void GetWidth(long Index, double * StartWidth, double * EndWidth)
	{
		static BYTE parms[] = VTS_I4 VTS_PR8 VTS_PR8 ;
		InvokeHelper(0x8, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Index, StartWidth, EndWidth);
	}
	void SetWidth(long Index, double StartWidth, double EndWidth)
	{
		static BYTE parms[] = VTS_I4 VTS_R8 VTS_R8 ;
		InvokeHelper(0x9, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Index, StartWidth, EndWidth);
	}
	double get_ConstantWidth()
	{
		double result;
		InvokeHelper(0xa, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, NULL);
		return result;
	}
	void put_ConstantWidth(double newValue)
	{
		static BYTE parms[] = VTS_R8 ;
	...
	VARIANT Offset(double Distance)
	{
		VARIANT result;
		static BYTE parms[] = VTS_R8 ;
		InvokeHelper(0xb, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, Distance);
		return result;
	}
	...
	VARIANT get_Coordinate(long Index)
	{
		VARIANT result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0xe, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, parms, Index);
		return result;
	}
	void put_Coordinate(long Index, VARIANT& newValue)
	{
		static BYTE parms[] = VTS_I4 VTS_VARIANT ;
		InvokeHelper(0xe, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, Index, &newValue);
	}
	BOOL get_Closed()
	{
		BOOL result;
	...
	BOOL get_LinetypeGeneration()
	{
		BOOL result;
		InvokeHelper(0x10, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_LinetypeGeneration(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
