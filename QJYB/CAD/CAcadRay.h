...
// CAcadRay wrapper class

class CAcadRay : public COleDispatchDriver
{
public:
	CAcadRay(){} // Calls COleDispatchDriver default constructor
	CAcadRay(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadRay(const CAcadRay& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
