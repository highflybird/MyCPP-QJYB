...
// CAcadPlotConfigurations wrapper class

class CAcadPlotConfigurations : public COleDispatchDriver
{
public:
	CAcadPlotConfigurations(){} // Calls COleDispatchDriver default constructor
	CAcadPlotConfigurations(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadPlotConfigurations(const CAcadPlotConfigurations& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	// IAcadPlotConfigurations methods
public:
	CString get_Handle()
	{
		CString result;
	...
	LPDISPATCH Add(LPCTSTR Name, VARIANT& ModelType)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_BSTR VTS_VARIANT ;
		InvokeHelper(0x2, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Name, &ModelType);
		return result;
	}
