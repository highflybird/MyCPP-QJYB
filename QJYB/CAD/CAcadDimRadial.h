...
// CAcadDimRadial wrapper class

class CAcadDimRadial : public COleDispatchDriver
{
public:
	CAcadDimRadial(){} // Calls COleDispatchDriver default constructor
	CAcadDimRadial(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadDimRadial(const CAcadDimRadial& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	BOOL get_DimLineSuppress()
	{
		BOOL result;
		InvokeHelper(0x1a, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_DimLineSuppress(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
