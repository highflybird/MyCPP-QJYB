...
// CAcadLine wrapper class

class CAcadLine : public COleDispatchDriver
{
public:
	CAcadLine(){} // Calls COleDispatchDriver default constructor
	CAcadLine(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadLine(const CAcadLine& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void put_StartPoint(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT ;
	...
	void put_EndPoint(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT ;
	...
	VARIANT Offset(double Distance)
	{
		VARIANT result;
		static BYTE parms[] = VTS_R8 ;
		InvokeHelper(0x5, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, Distance);
		return result;
	}
	VARIANT get_Delta()
	{
