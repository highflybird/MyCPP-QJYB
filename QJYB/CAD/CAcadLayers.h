...
// CAcadLayers wrapper class

class CAcadLayers : public COleDispatchDriver
{
public:
	CAcadLayers(){} // Calls COleDispatchDriver default constructor
	CAcadLayers(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadLayers(const CAcadLayers& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
