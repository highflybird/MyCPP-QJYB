...
// CAcadPolygonMesh wrapper class

class CAcadPolygonMesh : public COleDispatchDriver
{
public:
	CAcadPolygonMesh(){} // Calls COleDispatchDriver default constructor
	CAcadPolygonMesh(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadPolygonMesh(const CAcadPolygonMesh& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void put_MDensity(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
	...
	void put_NDensity(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x5, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	long get_MVertexCount()
	{
		long result;
		InvokeHelper(0x6, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	long get_NVertexCount()
	{
		long result;
	...
	{
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0x9, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &vertex);
	}
	VARIANT Explode()
	{
		VARIANT result;
	...
	VARIANT get_Coordinate(long Index)
	{
		VARIANT result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0xb, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, parms, Index);
		return result;
	}
