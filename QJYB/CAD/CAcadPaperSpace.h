...
// CAcadPaperSpace wrapper class

class CAcadPaperSpace : public COleDispatchDriver
{
public:
	CAcadPaperSpace(){} // Calls COleDispatchDriver default constructor
	CAcadPaperSpace(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadPaperSpace(const CAcadPaperSpace& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	LPDISPATCH InsertBlock(VARIANT& InsertionPoint, LPCTSTR Name, double Xscale, double Yscale, double Zscale, double Rotation)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_VARIANT VTS_BSTR VTS_R8 VTS_R8 VTS_R8 VTS_R8 ;
		InvokeHelper(0x62a, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &InsertionPoint, Name, Xscale, Yscale, Zscale, Rotation);
		return result;
	}
	LPDISPATCH AddHatch(long PatternType, LPCTSTR PatternName, BOOL Associativity)
	{
		...
		InvokeHelper(0x62b, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, PatternType, PatternName, Associativity);
		return result;
	}
	...
	LPDISPATCH AddMInsertBlock(VARIANT& InsertionPoint, LPCTSTR Name, double Xscale, double Yscale, double Zscale, double Rotation, long NumRows, long NumColumns, long RowSpacing, long ColumnSpacing)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_VARIANT VTS_BSTR VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x631, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &InsertionPoint, Name, Xscale, Yscale, Zscale, Rotation, NumRows, NumColumns, RowSpacing, ColumnSpacing);
		return result;
	}
	...
	LPDISPATCH AttachExternalReference(LPCTSTR PathName, LPCTSTR Name, VARIANT& InsertionPoint, double Xscale, double Yscale, double Zscale, double Rotation, BOOL bOverlay)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_VARIANT VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_BOOL ;
		InvokeHelper(0x636, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, PathName, Name, &InsertionPoint, Xscale, Yscale, Zscale, Rotation, bOverlay);
		return result;
	}
	void Unload()
	{
	...
	LPDISPATCH AddPViewport(VARIANT& Center, double Width, double Height)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_VARIANT VTS_R8 VTS_R8 ;
		InvokeHelper(0x1, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &Center, Width, Height);
		return result;
	}
