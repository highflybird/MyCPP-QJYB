...
public:
	...
	LPDISPATCH Open(LPCTSTR FullName)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x2a, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, FullName);
		return result;
	}
	...
	void SaveAs(LPCTSTR FullFileName, VARIANT& SaveAsType)
	{
		static BYTE parms[] = VTS_BSTR VTS_VARIANT ;
		InvokeHelper(0x30, DISPATCH_METHOD, VT_EMPTY, NULL, parms, FullFileName, &SaveAsType);
	}
