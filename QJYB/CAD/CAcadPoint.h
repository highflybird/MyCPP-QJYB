...
// CAcadPoint wrapper class

class CAcadPoint : public COleDispatchDriver
{
public:
	CAcadPoint(){} // Calls COleDispatchDriver default constructor
	CAcadPoint(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadPoint(const CAcadPoint& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
