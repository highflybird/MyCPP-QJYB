...
// CAcadBlock wrapper class

class CAcadBlock : public COleDispatchDriver
{
public:
	CAcadBlock(){} // Calls COleDispatchDriver default constructor
	CAcadBlock(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadBlock(const CAcadBlock& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
