...
// CAcad3DSolid wrapper class

class CAcad3DSolid : public COleDispatchDriver
{
public:
	CAcad3DSolid(){} // Calls COleDispatchDriver default constructor
	CAcad3DSolid(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcad3DSolid(const CAcad3DSolid& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void Boolean(long Operation, LPDISPATCH SolidObject)
	{
		...
		InvokeHelper(0x8, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Operation, SolidObject);
	}
	LPDISPATCH CheckInterference(LPDISPATCH Object, BOOL CreateInterferenceSolid)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_DISPATCH VTS_BOOL ;
		InvokeHelper(0x9, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Object, CreateInterferenceSolid);
		return result;
	}
	LPDISPATCH SectionSolid(VARIANT& Point1, VARIANT& Point2, VARIANT& point3)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT ;
		InvokeHelper(0xa, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &Point1, &Point2, &point3);
		return result;
	}
	LPDISPATCH SliceSolid(VARIANT& Point1, VARIANT& Point2, VARIANT& point3, BOOL Negative)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_BOOL ;
		InvokeHelper(0xb, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &Point1, &Point2, &point3, Negative);
		return result;
	}
