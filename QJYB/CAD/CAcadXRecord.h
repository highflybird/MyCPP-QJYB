...
// CAcadXRecord wrapper class

class CAcadXRecord : public COleDispatchDriver
{
public:
	CAcadXRecord(){} // Calls COleDispatchDriver default constructor
	CAcadXRecord(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadXRecord(const CAcadXRecord& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void GetXRecordData(VARIANT * XRecordDataType, VARIANT * XRecordDataValue)
	{
		...
		InvokeHelper(0x2, DISPATCH_METHOD, VT_EMPTY, NULL, parms, XRecordDataType, XRecordDataValue);
	}
	void SetXRecordData(VARIANT& XRecordDataType, VARIANT& XRecordDataValue)
	{
		static BYTE parms[] = VTS_VARIANT VTS_VARIANT ;
		InvokeHelper(0x3, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &XRecordDataType, &XRecordDataValue);
	}
	BOOL get_TranslateIDs()
	{
		BOOL result;
		InvokeHelper(0x4, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_TranslateIDs(BOOL newValue)
	{
