...
// CAcadLayout wrapper class

class CAcadLayout : public COleDispatchDriver
{
public:
	CAcadLayout(){} // Calls COleDispatchDriver default constructor
	CAcadLayout(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadLayout(const CAcadLayout& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
