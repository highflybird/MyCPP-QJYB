...
// CAcadMText wrapper class

class CAcadMText : public COleDispatchDriver
{
public:
	CAcadMText(){} // Calls COleDispatchDriver default constructor
	CAcadMText(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadMText(const CAcadMText& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	long get_AttachmentPoint()
	{
		long result;
		InvokeHelper(0x3, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_AttachmentPoint(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x3, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	long get_DrawingDirection()
	{
		long result;
		InvokeHelper(0x4, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_DrawingDirection(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
	...
	double get_LineSpacingFactor()
	{
		double result;
		InvokeHelper(0xa, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, NULL);
		return result;
	}
	void put_LineSpacingFactor(double newValue)
	{
		static BYTE parms[] = VTS_R8 ;
		InvokeHelper(0xa, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	long get_LineSpacingStyle()
	{
		long result;
		InvokeHelper(0xb, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_LineSpacingStyle(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
