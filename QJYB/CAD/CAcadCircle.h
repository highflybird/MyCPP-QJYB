...
// CAcadCircle wrapper class

class CAcadCircle : public COleDispatchDriver
{
public:
	CAcadCircle(){} // Calls COleDispatchDriver default constructor
	CAcadCircle(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadCircle(const CAcadCircle& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void put_Radius(double newValue)
	{
		static BYTE parms[] = VTS_R8 ;
	...
	void put_Diameter(double newValue)
	{
		static BYTE parms[] = VTS_R8 ;
	...
	void put_Circumference(double newValue)
	{
		static BYTE parms[] = VTS_R8 ;
	...
	VARIANT Offset(double Distance)
	{
		VARIANT result;
		static BYTE parms[] = VTS_R8 ;
		InvokeHelper(0x8, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, Distance);
		return result;
	}
