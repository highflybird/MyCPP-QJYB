...
// CAcadTextStyles wrapper class

class CAcadTextStyles : public COleDispatchDriver
{
public:
	CAcadTextStyles(){} // Calls COleDispatchDriver default constructor
	CAcadTextStyles(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadTextStyles(const CAcadTextStyles& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
