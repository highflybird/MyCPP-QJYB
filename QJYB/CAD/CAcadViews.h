...
// CAcadViews wrapper class

class CAcadViews : public COleDispatchDriver
{
public:
	CAcadViews(){} // Calls COleDispatchDriver default constructor
	CAcadViews(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadViews(const CAcadViews& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
