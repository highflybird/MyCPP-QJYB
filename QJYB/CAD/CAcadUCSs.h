...
// CAcadUCSs wrapper class

class CAcadUCSs : public COleDispatchDriver
{
public:
	CAcadUCSs(){} // Calls COleDispatchDriver default constructor
	CAcadUCSs(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadUCSs(const CAcadUCSs& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	LPDISPATCH Add(VARIANT& Origin, VARIANT& XAxisPoint, VARIANT& YAxisPoint, LPCTSTR Name)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_BSTR ;
		InvokeHelper(0x2, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &Origin, &XAxisPoint, &YAxisPoint, Name);
		return result;
	}
