...
// CAcadRegion wrapper class

class CAcadRegion : public COleDispatchDriver
{
public:
	CAcadRegion(){} // Calls COleDispatchDriver default constructor
	CAcadRegion(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadRegion(const CAcadRegion& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void Boolean(long Operation, LPDISPATCH Object)
	{
		...
		InvokeHelper(0xa, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Operation, Object);
	}
	VARIANT Explode()
	{
		VARIANT result;
