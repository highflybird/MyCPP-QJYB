...
// CAcadSolid wrapper class

class CAcadSolid : public COleDispatchDriver
{
public:
	CAcadSolid(){} // Calls COleDispatchDriver default constructor
	CAcadSolid(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadSolid(const CAcadSolid& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
