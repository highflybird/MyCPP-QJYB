...
// CAcadEntity wrapper class

class CAcadEntity : public COleDispatchDriver
{
public:
	CAcadEntity(){} // Calls COleDispatchDriver default constructor
	CAcadEntity(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadEntity(const CAcadEntity& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
