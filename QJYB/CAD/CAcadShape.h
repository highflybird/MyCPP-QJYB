...
// CAcadShape wrapper class

class CAcadShape : public COleDispatchDriver
{
public:
	CAcadShape(){} // Calls COleDispatchDriver default constructor
	CAcadShape(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadShape(const CAcadShape& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
