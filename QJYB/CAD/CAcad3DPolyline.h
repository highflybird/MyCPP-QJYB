...
// CAcad3DPolyline wrapper class

class CAcad3DPolyline : public COleDispatchDriver
{
public:
	CAcad3DPolyline(){} // Calls COleDispatchDriver default constructor
	CAcad3DPolyline(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcad3DPolyline(const CAcad3DPolyline& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0x2, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &vertex);
	}
	VARIANT Explode()
	{
		VARIANT result;
