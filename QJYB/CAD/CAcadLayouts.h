...
// CAcadLayouts wrapper class

class CAcadLayouts : public COleDispatchDriver
{
public:
	CAcadLayouts(){} // Calls COleDispatchDriver default constructor
	CAcadLayouts(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadLayouts(const CAcadLayouts& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
