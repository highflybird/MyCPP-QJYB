...
// CAcadRegisteredApplication wrapper class

class CAcadRegisteredApplication : public COleDispatchDriver
{
public:
	CAcadRegisteredApplication(){} // Calls COleDispatchDriver default constructor
	CAcadRegisteredApplication(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadRegisteredApplication(const CAcadRegisteredApplication& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	// IAcadRegisteredApplication methods
public:
	CString get_Handle()
	{
		CString result;
