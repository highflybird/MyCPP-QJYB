...
// CAcadPolyline wrapper class

class CAcadPolyline : public COleDispatchDriver
{
public:
	CAcadPolyline(){} // Calls COleDispatchDriver default constructor
	CAcadPolyline(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadPolyline(const CAcadPolyline& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void AppendVertex(VARIANT& vertex)
	{
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0x4, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &vertex);
	}
	VARIANT Explode()
	{
		VARIANT result;
	...
	VARIANT get_Coordinate(long Index)
	{
		VARIANT result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x11, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, parms, Index);
		return result;
	}
	void put_Coordinate(long Index, VARIANT& newValue)
	{
		static BYTE parms[] = VTS_I4 VTS_VARIANT ;
		InvokeHelper(0x11, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, Index, &newValue);
	}
