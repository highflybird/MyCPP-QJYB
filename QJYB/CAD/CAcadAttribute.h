...
// CAcadAttribute wrapper class

class CAcadAttribute : public COleDispatchDriver
{
public:
	CAcadAttribute(){} // Calls COleDispatchDriver default constructor
	CAcadAttribute(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadAttribute(const CAcadAttribute& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	long get_FieldLength()
	{
		long result;
		InvokeHelper(0x1, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_FieldLength(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
	...
	void put_PromptString(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x3, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	CString get_TextString()
	{
		CString result;
		InvokeHelper(0x4, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
		return result;
	}
	void put_TextString(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR ;
	...
	VARIANT get_TextAlignmentPoint()
	{
		VARIANT result;
		InvokeHelper(0xd, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
		return result;
	}
	void put_TextAlignmentPoint(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0xd, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, &newValue);
	}
	VARIANT get_InsertionPoint()
	{
		VARIANT result;
		InvokeHelper(0xe, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
		return result;
	}
	void put_InsertionPoint(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT ;
	...
	void put_UpsideDown(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
	...
	void put_Backward(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
	...
	void put_Invisible(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
	...
	void put_Constant(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
