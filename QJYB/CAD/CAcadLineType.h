...
// CAcadLineType wrapper class

class CAcadLineType : public COleDispatchDriver
{
public:
	CAcadLineType(){} // Calls COleDispatchDriver default constructor
	CAcadLineType(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadLineType(const CAcadLineType& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
