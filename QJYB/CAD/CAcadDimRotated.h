...
// CAcadDimRotated wrapper class

class CAcadDimRotated : public COleDispatchDriver
{
public:
	CAcadDimRotated(){} // Calls COleDispatchDriver default constructor
	CAcadDimRotated(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadDimRotated(const CAcadDimRotated& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
