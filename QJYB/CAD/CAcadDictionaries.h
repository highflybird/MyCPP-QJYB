...
// CAcadDictionaries wrapper class

class CAcadDictionaries : public COleDispatchDriver
{
public:
	CAcadDictionaries(){} // Calls COleDispatchDriver default constructor
	CAcadDictionaries(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadDictionaries(const CAcadDictionaries& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
