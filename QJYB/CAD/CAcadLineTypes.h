...
// CAcadLineTypes wrapper class

class CAcadLineTypes : public COleDispatchDriver
{
public:
	CAcadLineTypes(){} // Calls COleDispatchDriver default constructor
	CAcadLineTypes(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadLineTypes(const CAcadLineTypes& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void Load(LPCTSTR Name, LPCTSTR FileName)
	{
		...
		InvokeHelper(0x3, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Name, FileName);
	}
