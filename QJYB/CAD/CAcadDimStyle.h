...
// CAcadDimStyle wrapper class

class CAcadDimStyle : public COleDispatchDriver
{
public:
	CAcadDimStyle(){} // Calls COleDispatchDriver default constructor
	CAcadDimStyle(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadDimStyle(const CAcadDimStyle& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void CopyFrom(LPDISPATCH StyleSource)
	{
		...
		InvokeHelper(0x2, DISPATCH_METHOD, VT_EMPTY, NULL, parms, StyleSource);
	}
