...
// CAcadDimAligned wrapper class

class CAcadDimAligned : public COleDispatchDriver
{
public:
	CAcadDimAligned(){} // Calls COleDispatchDriver default constructor
	CAcadDimAligned(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadDimAligned(const CAcadDimAligned& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	double get_DimensionLineExtend()
	{
		double result;
		InvokeHelper(0x10, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, NULL);
		return result;
	}
	void put_DimensionLineExtend(double newValue)
	{
		static BYTE parms[] = VTS_R8 ;
