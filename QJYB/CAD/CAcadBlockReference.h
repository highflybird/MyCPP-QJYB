...
// CAcadBlockReference wrapper class

class CAcadBlockReference : public COleDispatchDriver
{
public:
	CAcadBlockReference(){} // Calls COleDispatchDriver default constructor
	CAcadBlockReference(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadBlockReference(const CAcadBlockReference& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
