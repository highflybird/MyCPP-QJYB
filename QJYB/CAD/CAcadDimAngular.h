...
// CAcadDimAngular wrapper class

class CAcadDimAngular : public COleDispatchDriver
{
public:
	CAcadDimAngular(){} // Calls COleDispatchDriver default constructor
	CAcadDimAngular(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadDimAngular(const CAcadDimAngular& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	VARIANT get_ExtLine1StartPoint()
	{
		VARIANT result;
		InvokeHelper(0x25, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
		return result;
	}
	void put_ExtLine1StartPoint(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT ;
	...
	VARIANT get_ExtLine2StartPoint()
	{
		VARIANT result;
		InvokeHelper(0x27, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
		return result;
	}
	void put_ExtLine2StartPoint(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT ;
