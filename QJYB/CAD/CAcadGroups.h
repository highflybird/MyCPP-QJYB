...
// CAcadGroups wrapper class

class CAcadGroups : public COleDispatchDriver
{
public:
	CAcadGroups(){} // Calls COleDispatchDriver default constructor
	CAcadGroups(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadGroups(const CAcadGroups& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
