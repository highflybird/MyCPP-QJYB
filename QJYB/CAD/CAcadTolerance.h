...
// CAcadTolerance wrapper class

class CAcadTolerance : public COleDispatchDriver
{
public:
	CAcadTolerance(){} // Calls COleDispatchDriver default constructor
	CAcadTolerance(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadTolerance(const CAcadTolerance& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
