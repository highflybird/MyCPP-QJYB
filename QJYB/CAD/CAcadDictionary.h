...
// CAcadDictionary wrapper class

class CAcadDictionary : public COleDispatchDriver
{
public:
	CAcadDictionary(){} // Calls COleDispatchDriver default constructor
	CAcadDictionary(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadDictionary(const CAcadDictionary& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	LPDISPATCH AddObject(LPCTSTR Keyword, LPCTSTR ObjectName)
	{
		...
		InvokeHelper(0x3, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Keyword, ObjectName);
		return result;
	}
	CString GetName(LPDISPATCH Object)
	{
		...
		InvokeHelper(0x4, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, Object);
		return result;
	}
	LPDISPATCH GetObject(LPCTSTR Name)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x5, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Name);
		return result;
	}
	LPDISPATCH Remove(LPCTSTR Name)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x6, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Name);
		return result;
	}
	void Rename(LPCTSTR OldName, LPCTSTR NewName)
	{
		static BYTE parms[] = VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x7, DISPATCH_METHOD, VT_EMPTY, NULL, parms, OldName, NewName);
	}
	void Replace(LPCTSTR OldName, LPDISPATCH pObj)
	{
		static BYTE parms[] = VTS_BSTR VTS_DISPATCH ;
		InvokeHelper(0x8, DISPATCH_METHOD, VT_EMPTY, NULL, parms, OldName, pObj);
	}
	...
	LPDISPATCH AddXRecord(LPCTSTR Keyword)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x9, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Keyword);
		return result;
	}
