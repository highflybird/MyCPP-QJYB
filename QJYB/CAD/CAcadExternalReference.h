...
// CAcadExternalReference wrapper class

class CAcadExternalReference : public COleDispatchDriver
{
public:
	CAcadExternalReference(){} // Calls COleDispatchDriver default constructor
	CAcadExternalReference(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAcadExternalReference(const CAcadExternalReference& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	// IAcadExternalReference methods
public:
	CString get_Handle()
	{
		CString result;
